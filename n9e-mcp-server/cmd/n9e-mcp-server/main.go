...
var rootCmd = &cobra.Command{
	Use:   "n9e-mcp-server",
	Short: "Nightingale MCP Server (stdio)",
	Long:  "Local stdio MCP for Nightingale. Default is read-only.",
	RunE:  runStdio,
}
...
func init() {
	...
	rootCmd.PersistentFlags().Bool("read-only", true, "Read-only mode (env: N9E_READ_ONLY)")
